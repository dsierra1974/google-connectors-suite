...
import org.mule.module.gmail.adapters.GmailConnectorHttpCallbackAdapter;
...
/**
 * A {@code GmailConnectorOAuthManager} is a wrapper around {@link GmailConnector } that adds access token management capabilities to the pojo.
 * 
 */
@Generated(value = "Mule DevKit Version 3.3.1", date = "2012-11-09T06:16:18-03:00", comments = "Build UNNAMED.1297.150f2c9")
public class GmailConnectorOAuthManager
    extends GmailConnectorHttpCallbackAdapter
    implements Capabilities, MetadataAware, MuleContextAware, Initialisable, OAuthManager<GmailConnectorOAuth2Adapter> , ProcessAdapter<GmailConnectorOAuth2Adapter>
{

    private static Logger logger = LoggerFactory.getLogger(GmailConnectorOAuthManager.class);
    private GmailConnectorOAuth2Adapter defaultUnauthorizedConnector;
     ...
     * 
     */
    public GmailConnectorOAuth2Adapter getDefaultUnauthorizedConnector() {
        ...
        throws InitialisationException
    {
        ...
        accessTokenPool = new GenericKeyedObjectPool(new GmailConnectorOAuthClientFactory(this), config);
        defaultUnauthorizedConnector = new GmailConnectorOAuth2Adapter();
    ...
    public GmailConnectorOAuth2Adapter createAccessToken(String verifier)
        throws Exception
    {
    ...
    public GmailConnectorOAuth2Adapter acquireAccessToken(String userId)
        throws Exception
    {
        return ((GmailConnectorOAuth2Adapter) accessTokenPool.borrowObject(userId));
    }

    public void releaseAccessToken(String userId, GmailConnectorOAuth2Adapter connector)
        throws Exception
    {
        accessTokenPool.returnObject(userId, connector);
    }

    public void destroyAccessToken(String userId, GmailConnectorOAuth2Adapter connector)
        throws Exception
    {
    ...
    @Override
    public<P >ProcessTemplate<P, GmailConnectorOAuth2Adapter> getProcessTemplate() {
